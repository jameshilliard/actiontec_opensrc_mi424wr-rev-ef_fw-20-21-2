...
#define ACTION_TEC_VERIZON_ENABLED (token_get("ACTION_TEC_VERIZON") && token_is_y("ACTION_TEC_VERIZON"))
#define ACTION_TEC_FRONTIER_ENABLED (token_get("ACTION_TEC_FRONTIER") && token_is_y("ACTION_TEC_FRONTIER"))
...
static void actiontec_set_names(void)
{
    ...
    {
	token_set("RMT_UPG_PATH", "NCSMI424WR2/MI424WR2.rmt");
	token_set("CWMP_ACS_URL", "https://cpe-ems.actiontec.com/cwmpWeb/CPEMgt");
    }
    else if (ACTION_TEC_VERIZON_ENABLED)
    {
	if (token_is_y("CONFIG_BHR_REV_E") || token_is_y("CONFIG_BHR_REV_F"))
	{
	    token_set("RMT_UPG_PATH", "MI424WR2/MI424WR_EF.rmt");
	    token_set("CWMP_ACS_URL", "https://cpe-ems0212.verizon.com/cwmpWeb/CPEMgt");
	}
	else if (token_is_y("CONFIG_BHR_REV_G"))
	{
	    token_set("RMT_UPG_PATH", "MI424WR2/MI424WR_G.rmt");
	    token_set("CWMP_ACS_URL", "https://cpe-ems0213.verizon.com/cwmpWeb/CPEMgt");
	}
	else if (token_is_y("CONFIG_BHR_REV_I"))
	{
	    token_set("RMT_UPG_PATH", "MI424WR-GEN3I/MI424WR-GEN3I.rmt");
	    token_set("CWMP_ACS_URL", "https://cpe-ems0214.verizon.com/cwmpWeb/CPEMgt");
	}
	else if (token_is_y("CONFIG_BHR_REV_J"))
	{
	    token_set("RMT_UPG_PATH", "MI424WR-GEN3J/MI424WR-GEN3J.rmt");
	    token_set("CWMP_ACS_URL", "https://cpe-ems0214.verizon.com/cwmpWeb/CPEMgt");
	}
	else
	{
	    token_set("RMT_UPG_PATH", "homerouter/homerouter.rmt");
	    token_set("CWMP_ACS_URL", "https://cpe-ems.verizon.net/cwmpWeb/CPEMgt");
	}
    }
    else
    {
...
void customer_common_features(void)
{
...
void verizon_features(void)
{
    customer_common_features();
    if (token_is_y("CONFIG_BHR_REV_I"))
	token_set_y("CONFIG_RG_MGMT_PASSWORD");
...
//	enable_module("MODULE_RG_JVM");
	...
	*/
	...
	if (!token_get("ACTION_TEC_SMALL_IMG"))
	{
	    if (token_is_y("CONFIG_BHR_REV_E"))
		enable_module("CONFIG_RG_ATHEROS_HW_AR5212"); 
	    if (token_is_y("CONFIG_BHR_REV_F") || token_is_y("CONFIG_BHR_REV_G"))
		enable_module("CONFIG_RG_ATHEROS_HW_AR5416");
	    token_set_y("CONFIG_ATHEROS_OLD_CARRIER");

	    token_set_y("CONFIG_RG_WIRELESS_TOOLS");
	    if (token_is_y("CONFIG_BHR_REV_E"))
		token_set_y("CONFIG_ATHEROS_MADWIFI_HOSTAPD");

	    enable_module("MODULE_RG_WPS");
	    token_set_y("CONFIG_RG_WPS");
	}

	if (token_is_y("CONFIG_BHR_REV_G"))
	    token_set("CONFIG_RG_DEFAULT_PSK", "y"); 
	...
	if (ACTION_TEC_VERIZON_ENABLED)
	    verizon_features();
	else if (ACTION_TEC_FRONTIER_ENABLED)
	    frontier_features();
	else if (ACTION_TEC_NCS_ENABLED)
	    ncs_features();
	{
	    token_set_y("CONFIG_GUI_RG");
	    token_set_y("CONFIG_GUI_RG2");
	...
	if (token_get("CONFIG_BHR_REV_F"))
	    token_set_y("CONFIG_USB_POWER_LIMIT");
